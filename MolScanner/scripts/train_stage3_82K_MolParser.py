"""
Stage 3: Real-Image RL Finetuning on 82K MolParser Data
========================================================
...
Continues from the Stage 1 (1M synthetic) checkpoint.
...
Usage:
    torchrun --nproc_per_node=4 scripts/train_stage3_82K_MolParser.py
    torchrun --nproc_per_node=4 scripts/train_stage3_82K_MolParser.py --resume
    python scripts/train_stage3_82K_MolParser.py --fast_test
"""
import sys
import os
